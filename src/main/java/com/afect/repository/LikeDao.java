...
public interface LikeDao  extends JpaRepository<Like, Integer> {
	...
	@Query(value = "SELECT * from af_likes where post_id=:postId and user_id=:userId ", nativeQuery = true)
	public Like checkLike(@Param("postId")Integer postId, @Param("userId")Integer userId);
